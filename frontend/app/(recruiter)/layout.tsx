...
import { RecruiterSidebar } from "@/constants";

function RecruiterDashboardContent({ children }: { children: ReactNode }) {
    ...
    const checkAuth = async () => {
      try {
        ...
        if (parsedUser.role !== "recruiter") {
          toast.error("Unauthorized access. Recruiter only.");
          router.push("/");
          return;
        }
                ...
                <DropdownMenu>
                  ...
                  >
                    ...
                    <div className="sm:hidden">
                      ...
                      <DropdownMenuItem
                        onClick={() =>
                          router.push("/recruiter-dashboard/settings")
                        }
...
export default function RecruiterDashboardLayout({
  ...
  return <RecruiterDashboardContent>{children}</RecruiterDashboardContent>;
}
