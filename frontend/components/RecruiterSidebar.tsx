...
const menuItems = [
  {
    ...
    items: [
      ...
      {
        title: "Connections",
        url: "/recruiter-dashboard/connections",
        icon: Users,
      },
      {
        title: "Messages",
        url: "/recruiter-dashboard/messages",
        icon: MessageCircle,
      },
    ],
  },
  {
    ...
    items: [
      {
        title: "Professionals",
        url: "/recruiter-dashboard/professionals",
        icon: Users,
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        title: "Resources",
        url: "/recruiter-dashboard/resources",
        icon: BookOpen,
      },
      {
        title: "Forum Posts",
        url: "/recruiter-dashboard/posts",
        icon: MessageSquare,
      },
    ],
  },
...
export function RecruiterSidebar({ user }: AppSidebarProps) {
      ...
      <SidebarHeader className="p-4 border-b border-slate-800">
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Recruiters Dashboard</p>
          </div>
        </Link>
      </SidebarHeader>
